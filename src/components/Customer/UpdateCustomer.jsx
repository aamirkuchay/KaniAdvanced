...
const UpdateCustomer = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      console.log(CustomerData,"custoo");
      ...
      if (CustomerData) {
        setInitialValues({
          ...
          discountOffered: CustomerData.discountOffered,
                  ...
                  <div>
                    ...
                    <label className="flex items-center">
                      <input
                        ...
                        name="retailLocation"
                        value="SRX"
                        checked={initialValues.retailLocation === 'SRX'}
                    ...
                    <label className="flex items-center">
                      <input
                        ...
                        name="retailLocation"
                        value="Delhi"
                        checked={initialValues.retailLocation === 'Delhi'}
                        onChange={handleRadioChange}
                      />
                    ...
                    <label className="flex items-center">
                      <input
                        ...
                        value="SXR and Delhi"
                        checked={
                          initialValues.retailLocation === 'SXR and Delhi'
                        }
                        onChange={handleRadioChange}
                      />
                  ...
                  <div>
                    ...
                    <label className="flex items-center">
                      <input
                        ...
                        checked={
                          initialValues.website === 'Subscribed/Purchased'
                        }
                        onChange={handleRadioChangeWebsite}
                      />
                  ...
                  <div>
                    ...
                    <label className="flex items-center">
                      <input
                        ...
                        name="social"
                        value="Interaction"
                        checked={initialValues.social === 'Interaction'}
                  ...
                  <div>
                    ...
                    <label className="flex items-center">
                      <input
                        ...
                        name="eventType"
                        value="Purchased"
                        checked={initialValues.eventType === 'Purchased'}
                        onChange={handleRadioChangeEventType}
                      />
                      <span className="ml-1">Purchased</span>
                      {formik.touched.eventType && formik.errors.eventType ? (
