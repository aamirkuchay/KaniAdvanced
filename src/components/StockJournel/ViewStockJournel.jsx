                                    ...
                                    <div className="flex flex-col gap-9">
                                        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark p-3">
                                            <div className="mb-4.5 flex flex-wrap gap-6">
                                                ...
                                                <div className="flex-1 min-w-[300px]">
                                                    <label className="mb-2.5 block text-black dark:text-white">Source Material</label>
                                                    <ReactSelect
                                                        name="description"
                                                        // value={descriptionValue}
                                                        onChange={option => setFieldValue("description", option?.label === "Select" ? "" : option?.label || '')}
                                                        value={descriptionSel.find(option => option.label === values.description)}
